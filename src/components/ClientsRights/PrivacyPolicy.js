...
const PrivacyPolicy = () => (
  <div className={styles.clientsRightsContainer}>
    ...
    <div className={styles.section}>
      <p>
        <b>Collection of Information:</b> Empire collects and uses the
        Information it receives to provide quality services to you. Such
        services include maintaining your accounts with the firm and processing
        securities transactions at your direction. Empire obtains most of the
        Information it requires directly from you at the time of account
        establishment - whether in person, by telephone or electronically.
        Empire may verify this Information or receive additional Information,
        including creditworthiness or credit history, from other financial
        institutions or service providers with whom you may have authorized to
        provide such Information and/or consumer reporting agencies,
        verification services or public sources. This Information may relate to
        your finances, employment, avocations or other personal characteristics,
        as well as interactions with or through Empire or others. In accordance
        with federal law, the firm may use any information it receives to verify
        your identity.
      </p>
    </div>
    ...
    <div className={styles.section}>
      <p>
        <b>Disclosure of Information:</b> Empire may not disclose Information
        about you to affiliates or nonaffiliated third parties except as
        permitted by law, as specifically consented by you, and to the
        following;
      </p>
    </div>
    ...
    <div className={styles.section}>
      <ul className={styles.wideItems}>
        ...
        <li>
          ...
          governmental or regulatory inquiry (including but not limited to, anti
          money laundering inquires);
        </li>
        <li>
        ...
        <li>
          ...
          transactions (such as money laundering violations, anti terrorist due
          diligence), law suits, claims or other liabilities.
        </li>
      </ul>
    </div>
    ...
    <div className={styles.section}>
      <p>
        <b>Empire does not make disclosures</b> of Information to other
        companies who may want to sell their products or services to you.
      </p>
    </div>
